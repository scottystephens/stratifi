...
CREATE TABLE IF NOT EXISTS xero_accounts (
    ...
    -- Link to normalized account in Stratifi
...
CREATE TABLE IF NOT EXISTS xero_transactions (
    ...
    -- Link to normalized transaction in Stratifi
...
CREATE INDEX IF NOT EXISTS idx_xero_accounts_stratifi_id ON xero_accounts(stratifi_account_id);
...
CREATE INDEX IF NOT EXISTS idx_xero_transactions_stratifi_id ON xero_transactions(stratifi_transaction_id);
